...
public class ReplyToInviteHttpRequest extends AsyncTask<Object, Object, String> {
    ...
    protected String doInBackground(Object... params) {
        ...
        ReplyToInviteHttpRequest.JSONResponseHandler responseHandler = new ReplyToInviteHttpRequest.JSONResponseHandler();
        try {
    ...
    protected void onPreExecute() {
        ...
        asyncDialog.setMessage("Replying");
        asyncDialog.show();
    }
